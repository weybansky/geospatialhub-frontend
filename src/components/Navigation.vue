<template>
  <nav class="navigation">
    ...
    <router-link to="/profile" class="nav-link hidden-tablet hidden-mobile">
      <div class="nav-link-icon">
        <svg
          class="icon"
          width="60"
    ...
    <router-link to="/chats" class="nav-link">
      <div class="nav-link-icon">
        ...
        <span class="notification-dot" v-if="messageUnreadCount"></span>
      </div>
    ...
    <router-link to="/notifications" class="nav-link" exact>
      <div class="nav-link-icon">
        ...
        <span class="notification-dot" v-if="notificationUnreadCount"></span>
      </div>
