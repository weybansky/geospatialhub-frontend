  ...
  <div class="welcome-page bg-blue text-white">
    <nav class="container">
      ...
      <div class="links" v-if="!authenticated">
        <router-link class="link blue" to="/register">Join Now</router-link>
        <router-link class="link white" to="/login">Sign In</router-link>
      </div>
    ...
    <footer class="container">
      <h3>The larget selection of Geospatial Courses from Africa</h3>
      <p class="courses">
